import logging, psutil, os, sys, time
...
class DebugInterface :
    ...
    def drawFrame(self) :
        ...
        self.stdscr.addstr(2, 2, "─── GINGER LED VISUALIZATION V0.3 ───")
        self.stdscr.addstr(3, 2, "─────────────────────────────────────")
        self.stdscr.addstr(5, 2, "Cpu in % -> " + str(getCpuInPercent()))
        self.stdscr.addstr(6, 2, "Mem in % -> " + str(getVirtualMemoryConsumtion()["percent"]))
        print(str(getVirtualMemoryConsumtion()))
        self.stdscr.addstr(7, 2, "FPS -> " + self.framerateCalculator.printFps())
        self.stdscr.addstr(9, 2, "Current mode -> " + self.visualization.active_mod)
        self.stdscr.addstr(11, 2, "Is reverse -> " + str(self.visualization.is_reverse))
        self.stdscr.addstr(12, 2, "Is full strip -> " + str(self.visualization.is_full_strip))
        self.stdscr.addstr(13, 2, "Is monochrome -> " + str(self.visualization.is_monochrome))
        self.stdscr.addstr(14, 2, "Is mirror -> " + str(self.visualization.is_mirror))
