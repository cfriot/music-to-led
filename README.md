...
| ![scroll](images/envelope.gif) | G-2 | **pitchwheel_flash** | Make the whole strip illuminates according to the pitch bend intensity of your keyboard. Brightness is based on pitch bend. Begin on a black strip.<ul><li>**color** First color of the scheme. </li>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgxNzQ4NTE4Ml19
-->